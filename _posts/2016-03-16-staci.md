...
STACI is a proof of concept codebase to play with the idea of making containers configurable and deployable with ease. And we did it in a simple language, to get everyone onboard. Namely `bash`.
